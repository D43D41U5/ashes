 ...
 */
describe('l’inventaire des 64 faits', () => {
  ...
  it('les familles PARTITIONNENT les 64 faits — chacune en porte, aucune n’est vide', () => {
  ...
  it('l’état publié est bien l’état ACTUEL : 38 voix, 26 silences décidés', () => {
