...
/**
 * (La passe de MATIÈRE en MULTIPLY — l'atlas des cinq familles, spec da-feeling R19 — a vécu ici
 * du 2026-07-30 au 2026-08-22. Elle est désormais CUITE DANS les pavés (`pave-layer.ts`,
 * `render/paves.ts`) : le grain de famille entre directement dans l'image à 16 px/tuile, une
 * seule image, une seule échelle. `grain-sol.ts` reste la source des trames.)
 */
