...
export { attacheAuFil, COULEE, cranDeSang, eauSouillee, empreinteDuSang, filsDe, finDuFleuve, pasEnAval, qualiteDeLEau, tableDAttache, type EtatDeCendre, type EtatQualiteEau, type FilsDeLaCarte, type Souillure } from './coulee'
