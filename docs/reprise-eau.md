...
- **Gardes** : `qualite-eau.test.ts`, 28 tests. Suites au commit : sim 2 338 (plancher 2 328), client 1 565, serveur 36, banc 3 — comptes relevés avec, en plus, 5 tests non commités de l'autre session (étages).
