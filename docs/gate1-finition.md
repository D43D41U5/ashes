...
3. ~~**Raffinement du garde réfugiés.**~~ *(sans objet — les réfugiés sont retirés du jeu, 2026-08-30)* Mon correctif anti-double-envoi impose un geste par groupe. Si tu veux permettre nourrir-puis-recruter, je passe le garde de « par groupe » à « par (groupe, verbe) ». Ton appel.
