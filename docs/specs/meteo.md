...
- **R6 — La faune se terre.** Le front pose `faunaQuiet` sur son empreinte pendant la traversée (plomberie livrée par la Brume R6 ; les entrées portent leur source — la purge de l'un ne fauche jamais l'autre). Le retour du gibier après l'averse est une fenêtre de chasse lisible.
...
- **A5** — `faunaQuiet` couvre l'empreinte pendant la traversée et se lève après ; une Brume et un front de pluie simultanés ne se purgent pas mutuellement.
