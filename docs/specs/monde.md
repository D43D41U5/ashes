...
- **R2 — Deux échelles de temps distinctes**, comme dans Rust :
  - **Le cycle** (jour/nuit diégétique) : `CYCLE_REAL_MINUTES = 45` minutes réelles — 28 min de jour, 17 min de nuit (`CYCLE_DAY_FRACTION = 0.625`). *(48 jusqu'au 2026-08-23 ; « un jour dure 45 minutes », décision d'Alexis.)* Une session d'une heure voit un jour *et* une nuit ; la nuit est assez longue pour une horde, assez courte pour ne pas frustrer.
