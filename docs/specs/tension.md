...
- **T11bis — …et le loin est DANGEREUX** (`predatorBias`) : près du foyer, les prédateurs sont rares ; aux marges, le monde leur appartient. Sans ce gradient, le cercle sauvage était riche **sans être dangereux** — s'éloigner rapportait sans faire peur, et le poids n'achetait aucune tension. **Les deux règles se tiennent la main.**
