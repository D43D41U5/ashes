...
- **T11bis — …et le loin est DANGEREUX** *(amendé 2026-08-28 — le gradient de tirage `predatorBias` est RETIRÉ avec le canal ambiant des prédateurs, faune R28)* : le danger des marges est désormais porté par des **LIEUX** — les **Louvières** (meutes résidentes — Sylve, Alpages, et `pres_bas` tant que le monde joué est le T0 seul) et leurs coins de chasse garantis — et par la **nuit qui chasse**, plus forte aux actes tardifs. Le principe tient : s'éloigner rapporte ET fait peur ; mais le danger s'**apprend et se contourne** au lieu d'être un brouillard de tirage.
