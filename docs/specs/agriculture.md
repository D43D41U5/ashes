...
- **A6** — **La serre (R7)** : en acte III, semer une `parcelle` de plein air est refusé (« la terre est gelée »), semer une `serre` réussit (`plantedAt` posé). L'acte se dérive du calendrier (pur) — testé via une échelle calendaire élevée.
