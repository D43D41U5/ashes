...
- **A6** — La caméra se décale vers le curseur, bornée par `LOOKAHEAD_MAX_TILES`, et ne montre jamais le void près des bords de carte. Déplacer le curseur ne crée aucune oscillation (calcul écran-espace).
