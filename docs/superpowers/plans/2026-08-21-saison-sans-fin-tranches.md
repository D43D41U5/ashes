...
### T5 — P5b : la mémoire des hivers *(LIVRÉE — « ok pour la reco » : la chronique se scelle au tour de l'année ; volumes dans la sauvegarde et le message `ready`, journal par années vu en jeu ; `registreDuLieu` pure et testée, son écran reste à faire)*
